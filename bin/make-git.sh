...
case ${BITBUCKET_MINOR_VERSION} in
    ...
    8.4)  SUPPORTED_GIT_VERSION="2.37" ;;
    8.5)  SUPPORTED_GIT_VERSION="2.37" ;;
    8.6)  SUPPORTED_GIT_VERSION="2.37" ;;
    8.7)  SUPPORTED_GIT_VERSION="2.38" ;;
    8.8)  SUPPORTED_GIT_VERSION="2.39" ;;
    8.9)  SUPPORTED_GIT_VERSION="2.40" ;;
      *)  SUPPORTED_GIT_VERSION="2.40" ;;
esac
